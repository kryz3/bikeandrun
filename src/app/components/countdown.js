...
export default function CountdownTimer({ targetDate }) {
  ...
  return (
    ...
    <a href="/guide"><h2 className="text-xl sm:text-2xl mb-4 text-center bnr-font hover:text-bnr-rose transition-colors text-white text-stroke drop-shadow-[2px_2px_0px_black]">
